//
//  THGestureClassifierPopoverGraphView.m
//  TangoHapps
//
...
@interface THGestureClassifierPopoverGraphView ()
...
@implementation THGestureClassifierPopoverGraphView
...
- (void)stoppedDragging
{
    ...
    [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:@"gestureMovedBar" object:Nil userInfo:d]];
}
